...
class UI:
    ...
    class ImageSaveHelper:
        ...
        @staticmethod
        def get_save_images_ui(images, filename_prefix: str, cls: Type[ComfyNode] | None, compress_level=4) -> UI.SavedImages:
    ...
    class PreviewMask(PreviewImage):
        def __init__(self, mask: UI.PreviewMask.Type, animated: bool=False, cls: ComfyNode=None, **kwargs):
